...
V10_DETECT_CLASS = (v10Detect, Detect_NMSFree, v10Detect_LSCD, v10Detect_SEAM, v10Detect_MultiSEAM, v10Detect_TADDH, v10Detect_Dyhead, v10Detect_DyHeadWithDCNV3, v10Detect_DyHeadWithDCNV4)
...
def parse_model(d, ch, verbose=True, warehouse_manager=None):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d["backbone"] + d["head"]):  # from, number, module, args
        ...
        if m in {
            ...
            C2f_IdentityFormerCGLU, C2f_RandomMixingCGLU, C2f_PoolingFormerCGLU, C2f_ConvFormerCGLU, C2f_CaFormerCGLU, CSP_MutilScaleEdgeInformationEnhance, C2f_FFCM, DTM
        }:
            if args[0] == 'head_channel':
                args[0] = d[args[0]]
            c1, c2 = ch[f], args[0]
            ...
            if m in SEGMENT_CLASS:
                ...
                if m in (Segment_LSCD, Segment_TADDH, Segment_LSCSBD, Segment_LSDECD):
                    args[3] = make_divisible(min(args[3], max_channels) * width, 8)
            if m in (Detect_LSCD, Detect_TADDH, Detect_LSCSBD, Detect_LSDECD, v10Detect_LSCD, v10Detect_TADDH):
